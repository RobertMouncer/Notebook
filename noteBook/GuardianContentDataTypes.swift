...
struct GuardianOpenPlatformFields: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        // Int values (transformed from strings)
        ...
        // Bool values (transformed from strings)
 ...
 */
enum GuardianContentOrderFilter: String {
    case newest
    case oldest
    case relevance
}
...
class GuardianContentFilters: GuardianContentTagFilters {
    ...
    override func queryParameters() -> String {
        ...
        if let showfieldsValue = showFields {
            result.append("show-fields=\(showfieldsValue)")
        }
